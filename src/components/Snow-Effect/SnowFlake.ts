export default class Snowflake {
    ...
    counter: number;
    sign: number;
    constructor(element: any, speed: number, xPos: number, yPos: number) {
    ...
    update(delta: number, browserHeight: number) {
    ...
    setTransform(xPos: number, yPos: number, scale: number, el: { style: { transform: string; }; }) {
